...
public class JFrameThings {
	...
	public static void main(String[] args) {
		...
		MagicLabel lbl = new MagicLabel("maybe", true);
		MagicLabel lbl2 = new MagicLabel("Yes", false);
		MagicLabel lbl3 = new MagicLabel("No", false);
		lbl.setBounds(100, 50, 200, 40);
		lbl2.setBounds(100, 100, 200, 40);
		lbl2.setBackground(Color.red);
		lbl2.setOpaque(true);
		lbl3.setBounds(100, 150, 200, 40);
		cont.add(lbl);
		cont.add(lbl2);
		cont.add(lbl3);
		MyListener ml1 = new MyListener();
		
		lbl.addMouseListener(ml1);
		lbl2.addMouseListener(ml1);
		lbl3.addMouseListener(ml1);
		
		
		Rectangle r1 = btn1.getVisibleRect();
		Rectangle r2 = lbl2.getVisibleRect();
		cont.repaint();
